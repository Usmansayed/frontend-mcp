...
> **See also:** [INTELLIGENCE_MODULES.md](./INTELLIGENCE_MODULES.md) — the canonical map of all eight intelligence modules.
...
Frontend Perception MCP  (deterministic runtime — no LLM)
        ↓
Eight Intelligence Modules + Core
        ↓
...
## Intelligence module layout (v0.12)

```text
src/navigation/
├── core/                         # envelope, scan registry, CDP hub, budgets
├── framework_intelligence/       # 1 — stack detection + on-demand docs
