...
def __getattr__(name: str):  # noqa: ANN001
	if name == 'CandidateProfile':
		from navigation.inspiration_intelligence.models import CandidateProfile
	...
	if name == 'normalize_candidate':
		from navigation.inspiration_intelligence.candidate_intelligence.normalizer import normalize_candidate
