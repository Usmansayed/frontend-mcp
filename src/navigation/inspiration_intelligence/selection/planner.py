...
from navigation.inspiration_intelligence.models import InspirationRankedCandidate
from navigation.inspiration_intelligence.selection.models import (
	SelectedCandidate,
	SelectionBudget,
	SelectionPlan,
)
...
_DESIGN_SYSTEM_STOPWORDS = frozenset(
	{'ui', 'kit', 'template', 'design', 'system', 'inspiration', 'gallery', 'free', 'the', 'and', 'for'}
)
...
def build_selection_plan(
	...
	*,
	...
	reserve: list[InspirationRankedCandidate] = []

	def try_add(item: InspirationRankedCandidate, batch: int, reason: str) -> bool:
...
def _design_system_key(item: InspirationRankedCandidate) -> str:
