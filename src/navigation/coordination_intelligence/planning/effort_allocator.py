"""Engineering Investment allocator — EQG, ROI, diminishing returns, STOP (advisory)."""
...
def evaluate_allocation(
    ...
    *,
    ...
    """Score whether suggesting capability_id is worthwhile under R12 + budget."""
...
def apply_decision_to_briefing(psm: ProjectSituationModel, decision: AllocationDecision) -> None:
    psm.episode.retry_counters["situation_policy_id"] = decision.policy_id
    psm.episode.retry_counters["investment_band"] = decision.investment_band
    psm.episode.retry_counters["visual_impact_ceiling"] = decision.visual_impact_ceiling
    psm.briefing.routing_rationale = decision.routing_rationale
    psm.briefing.benefit_claim = decision.benefit_claim
    psm.briefing.skip_condition = decision.skip_condition
    psm.briefing.investment = {
        "policy_id": decision.policy_id,
        "band": decision.investment_band,
