...
def build_community_plan(intent: FigmaIntent, search_plan: FigmaSearchPlan) -> CommunitySearchPlan:
...
def _detect_page_types(text: str, intent: FigmaIntent) -> list[str]:
	found: list[str] = []
...
def _detect_industries(text: str, intent: FigmaIntent) -> list[str]:
	found: list[str] = []
...
def _detect_styles(text: str, intent: FigmaIntent) -> list[str]:
