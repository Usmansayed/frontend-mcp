...
from coordination_sandbox.brain.effort_allocator import evaluate_allocation
...
def compile_bootstrap_strategy(
    ...
    *,
    ...
    from coordination_sandbox.brain.models import IntentFrame, ProjectSituationModel
    from coordination_sandbox.brain.situation_policy import intent_suggests_stage

    psm = ProjectSituationModel()
    psm.episode.intent_stack.append(IntentFrame(intent=intent))
